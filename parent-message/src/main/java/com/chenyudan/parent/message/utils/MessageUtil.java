package com.chenyudan.parent.message.utils;

import com.chenyudan.parent.message.spring.AbstractSpringMessageConsumerHandle;
import com.chenyudan.parent.message.spring.domain.SpringMessage;
